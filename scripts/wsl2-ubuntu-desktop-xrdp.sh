...
main() {
  ...
  info "Installing Ubuntu desktop + XRDP packages"
  run_root apt update
  run_root env DEBIAN_FRONTEND=noninteractive apt install -y xfce4 xfce4-goodies xrdp xorgxrdp dbus-x11 x11-xserver-utils
